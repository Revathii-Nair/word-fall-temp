export default function RoundDetails({ history }) {
  const rounds = [...history].sort((a, b) => Number(b.gameId) - Number(a.gameId));
    ...
    <div className="mt-6 rounded-2xl border border-brand-border bg-brand-card p-8">
      ...
      <div className="space-y-3">
        {rounds.length === 0 ? (
          ...
          rounds.map((round) => (
            <div key={round.gameId} className="rounded-xl border border-brand-border bg-background p-4">
